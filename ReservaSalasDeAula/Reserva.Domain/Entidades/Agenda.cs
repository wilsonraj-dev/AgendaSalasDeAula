...
namespace Reserva.Domain.Entidades
{
    public class Agenda : Entity
    {
        ...
        {
            DomainExceptionValidation.When(new DateTime(dataAgenda.Year, dataAgenda.Month, dataAgenda.Day) < DateTime.Now, "A data de agendamento da sala não pode ser menor que a data atual.");
